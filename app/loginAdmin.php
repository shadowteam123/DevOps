<?php session_start(); ob_start();
 // POUR ACCEDER A CETTE PAGE CLIQUEZ SUR LE LIEN INDIQUE TOUT EN DESSOUS DE LA PAGE D'ACCUEIL?>
...
<div id="who">
  ...
  <form method="post"  style="margin-left:20%;margin-right:20%; margin-top:7%; color:white;text-align:center">
        ...
        if(isset($_POST['submit']))
        {
            ...
            $req="select * from admin where idAdmin = '$id' and mdpA='$password'";
        ...
        ?>
         <br> 
         <label for="">IDENTIFIANT :</label> <br>                 <?php // mettez identifiant : admin ?>
         ...
         <label for="">MOT DE PASSE :</label> <br>                  <?php // mettez mot de passe : admin ?>
...
<div id="whosides"></div>
 ...
 <div id="foot">
      ...
      <?php include("note.php"); ob_end_flush();?>
      </div>
      <div></div>
      <div></div>
 </div>
