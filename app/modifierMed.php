...
<div id="str">
     ...
     $ss=mysqli_query($connect,"select * from medicaments where idMedicament='$idM' ");
     $reds=mysqli_fetch_array($ss);

     $nomM=$reds['nomM']; 
     $quanM=$reds['quantiteM'];
     $prixM=$reds['prixM']; 
     $photoM=$reds['photoM']; 
...
<div id="choixpharmGrid"style="text-align:center; width:96% ;background-color:#F0F8FF; font-weight:bold ; font-size:30px;color:#2565AE">
    ...
    <input style="width:270px;height:27px;font-size:18px;color:white;background-color:#1E90FF" type="text" name="nomM" 
           value=<?=$nomM?> placeholder="Saisir le nom du produit" autofocus required>
   ...
   <br> <label> Prix du Médicament : </label> <br> <br>
    <input style="width:250px;height:25px;font-size:18px;" type="number" name="prixM" 
           value=<?=$prixM?>   placeholder="Saisir le prix du produit" autofocus required> en FCFA
...
<div style="display: grid; grid-template-columns: 1fr 3fr 3fr 1fr ; grid-auto-rows: 240px;">
   ...
   <div  style="background-color:#1E90FF;color:white;font-weight:bold ; font-size:28px;text-align:center">
    <label for="">Changez de photo une photo du médicament : </label> <br> <br>
    <img src=<?=$photoM?> alt="" width="200px" height="120px">
 ...
 ?>
   ...
   <br> <label> Quantité du Médicament : </label> <br> <br>
    <input style="width:250px;height:25px;font-size:18px;" type="number" name="quantiteM" 
           value=<?=$quanM?>  placeholder="Saisir la quantite a ajouter" autofocus required>

   </div>
   <div>

   <input type="submit" value="Modifier"  name="submit" style=" margin-top:190px;height:52px;width:180px;
                                                                     background-color:teal;font-weight:bold;color:white;
                                                                      font-size:30px;"
                                                                      onclick="return(alert('Medicament modifié avec succes'))">     
 ...
 <?php 
     ...
     if(isset($_POST['submit']))
     {
       ...
       include("connectionBDD.php");
       $req=mysqli_query($connect,"update medicaments set nomM='$nomM', quantiteM='$quantiteM' 
                                  , prixM='$prixM' , photoM='$name' where idMedicament='$idM'");
