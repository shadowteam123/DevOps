pipeline {
	...
	//Tag des images
        stage('Tag des images') {
			...
			steps {
				sh 'docker tag continuous-delivery-pharmacies_mysql:latest shadowteam123/test:latest'
                		sh 'docker tag continuous-delivery-pharmacies_http:latest shadowteam123/test:latest'
